...
/// # Optimization
///
/// On a single core, atomics usually introduce unnecessary overhead. This
/// primitive uses compiler fences rather than full atomic access to synchronize
/// normal memory accesses around volatile access. This avoids redundant memory
/// barriers.
///
/// # Safety
///
...
///   access is going to be the recommended approach once volatile read/write
///   becomes atomic.
#[repr(transparent)]
